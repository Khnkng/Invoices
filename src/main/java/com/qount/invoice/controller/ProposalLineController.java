...
@Path("/users/{userID}/companies/{companyID}/proposal/{proposalID}/line")
public class ProposalLineController {
	...
	public List<ProposalLine> createProposal(@PathParam("userID") String userID, @PathParam("companyID") @NotNull String companyID,
	...
	@ApiOperation(value = "update proposal", notes = "Used to update proposal"
			...
			+ "</div>", responseContainer = "java.lang.String")
	public ProposalLine update(@PathParam("userID") String userID, @PathParam("companyID") @NotNull String companyID, @PathParam("proposalID") String proposalID,

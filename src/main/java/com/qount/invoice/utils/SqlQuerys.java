...
public class SqlQuerys {
	...
	public final class InvoiceLine {
		public final static String INSERT_QRY = "INSERT INTO `invoice_lines` (`id`,`invoice_id`,`description`,`objectives`,`amount`,`last_updated_by`,`last_updated_at`,`quantity`,`price`,`notes`,`item_id`,`coa_id`,`type`,`task_id`) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
		public final static String UPDATE_QRY = "update `invoice_lines` SET `invoice_id`=?,`description`=?,`objectives`=?,`amount`=?,`last_updated_by`=?,`last_updated_at`=?,`quantity`=?,`price`=?,`notes`=?, `item_id`=?, `coa_id` = ?, `task_id`=? where `id`=?";
		public final static String GET_LINES_QRY = "SELECT `task_id`,`id`,`invoice_id`,`description`,`objectives`,`amount`,`last_updated_by`,`last_updated_at`,`quantity`,`price`,`notes`,`item_id`,`coa_id` FROM invoice_lines WHERE `invoice_id` = ?;";

...
public class SqlQuerys {
	...
	public final class Invoice {
		...
		public final static String GET_INVOICES_LIST_QRY = "SELECT `po_number`,`invoice_date`,`payment_date`,`amount`,`currency`,`last_updated_by`,`last_updated_at`,`customer_id`,`state`,`amount_due`,`sub_totoal`,`amount_by_date` FROM invoice WHERE `user_id`=?;";
	...
	public final class ProposalLine {
		...
		public final static String DELETE_PROPOSAL_LINE_QRY = "DELETE FROM `proposal_lines` WHERE `proposal_id` = ?";
	}

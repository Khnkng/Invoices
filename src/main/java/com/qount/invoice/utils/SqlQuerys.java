...
public class SqlQuerys {
	...
	public final class Invoice {
		public static final String INSERT_QRY = "INSERT INTO invoice (`billing_from`, `billing_to`, `remit_payments_to`, `late_fee_id`, `late_fee_name`, `attachments_metadata`, `id`, `user_id`, `company_id`, `customer_id`, `amount`, `currency`, `description`, `objectives`, `last_updated_by`, `last_updated_at`, `state`, `invoice_date`, `notes`, `discount`, `deposit_amount`, `processing_fees`, `number`, `document_id`, `amount_due`, `due_date`, `sub_totoal`, `amount_by_date`, `created_at`, `amount_paid`, `term`, `created_at_millis`, `recepients_mails`, `plan_id`, `is_recurring`, `payment_options`, `email_state`, `send_to`,`payment_method`,`tax_amount`,`proposal_id`,`remainder_job_id`,`remainder_name`, `recurring_frequency`, `recurring_end_date` ) VALUES( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
		public static final String UPDATE_QRY = "UPDATE invoice SET `billing_from` = ?, `billing_to` = ?, `remit_payments_to` = ?,`late_fee_id`=?,`late_fee_name`=?,`attachments_metadata`=?,`remainder_job_id` = ?, `remainder_name` = ?, `user_id` = ?, `company_id` = ?, `customer_id` = ?, `amount` = ?, `currency` = ?, `description` = ?, `objectives` = ?, `last_updated_by` = ?, `last_updated_at` = ?, `state` = ?, `invoice_date` = ?, `notes` = ?, `discount` = ?, `deposit_amount` = ?, `processing_fees` = ?, `number` = ?, `document_id` = ?, `amount_due` = ?, `due_date` = ?, `sub_totoal` = ?, `amount_by_date` = ?, `amount_paid` = ?, `term` = ?, `recepients_mails` = ?, `plan_id` = ?, `is_recurring` = ?, `payment_options` = ?, `send_to` = ?,`payment_method` = ?, `tax_amount` = ?,`recurring_frequency` = ?,`recurring_end_date` = ? WHERE `id` = ?;";

...
public class SqlQuerys {
	...
	public final class Invoice {
		...
		public final static String GET_INVOICES_LIST_QRY = "SELECT `number`,`id`,`invoice_date`,`payment_date`,`amount`,`currency`,`state`,`amount_by_date`,`amount_due` FROM invoice WHERE ";
